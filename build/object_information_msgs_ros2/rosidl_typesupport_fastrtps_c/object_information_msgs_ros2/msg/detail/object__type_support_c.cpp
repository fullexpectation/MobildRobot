...
#include "object_information_msgs_ros2/msg/detail/object__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_object_information_msgs_ros2
...
using _Object__ros_msg_type = object_information_msgs_ros2__msg__Object;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detect_sequence
  {
    cdr << ros_message->detect_sequence;
  }

  // Field name: object_total
  {
...
static uint32_t _Object__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_object_information_msgs_ros2__msg__Object(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = object_information_msgs_ros2__msg__Object;
    is_plain =
      (
...
static size_t _Object__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_object_information_msgs_ros2__msg__Object(
